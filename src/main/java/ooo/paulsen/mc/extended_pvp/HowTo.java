...
public class HowTo implements CommandExecutor {
    ...
    private static ArrayList<String> getPages(){
        ...
        pages.add("    " + ChatColor.LIGHT_PURPLE + ChatColor.UNDERLINE + "<Extended PvP>\n\n" + ChatColor.RESET +
                ChatColor.BLUE+ChatColor.BOLD+ChatColor.UNDERLINE+"Usage:"+(Extended_PvP.enabled ? (ChatColor.GREEN+" ENABLED") : (ChatColor.RED+" DISABLED"))+"\n\n"+
        ...
        pages.add(ChatColor.RESET+"After being "+ChatColor.UNDERLINE+"killed by a Player"+ChatColor.RESET+", all items are dropped, except of a few other items which is set by the Admin.\n\n\n"+
